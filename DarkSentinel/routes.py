...
with app.app_context():
    ...
    # Add some test breach data if none exists
    if DataBreach.query.count() == 0:
        ...
        test_breaches = [
            DataBreach(
                ...
                source_url='https://darkweb.leaked-data.com',
                content_snippet='Found potential password leak: admin:secretpass123',
                breach_type='password,credentials',
            ...
            DataBreach(
                scan_id=test_scan.id,
                source_url='https://darkforum.hacks.net',
                content_snippet='Credit card data dump: 4532-XXXX-XXXX-1234',
                breach_type='credit_card',
            ...
            DataBreach(
                scan_id=test_scan.id,
                source_url='https://pastesite.darkweb.org',
                content_snippet='API keys exposed: sk_test_abcdefghijklmnop',
                breach_type='api_key',
        ...
        db.session.bulk_save_objects(test_breaches)
        db.session.commit()
